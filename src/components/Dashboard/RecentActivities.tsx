            ...
            <ul className="my-1">
                ...
                <div className="flex-grow flex items-center border-b border-gray-100 text-sm text-gray-600 py-2">
                  <div className="flex-grow flex justify-between items-center">
                    <div className="self-center">
                      <a className="font-medium text-gray-800 hover:text-gray-900 outlineStyle" href="#0">Nick Mark</a> mentioned <a className="font-medium text-gray-800 outlineStyle" href="#0" >Sara Smith</a> in a new post
                    </div>
              ...
              <li className="flex px-4">
                ...
                <div className="flex-grow flex items-center border-gray-100 text-sm text-gray-600 py-2">
                  <div className="flex-grow flex justify-between items-center">
                    <div className="self-center">
                      The post <a className="font-medium text-gray-800 outlineStyle" href="#0" >Post Name</a> was removed by <a className="font-medium text-gray-800 hover:text-gray-900 outlineStyle" href="#0">Nick Mark</a>
                    </div>
                    <div className="flex-shrink-0 ml-2">
                      <a className="flex items-center font-medium text-blue-500 hover:text-blue-600 outlineStyle" href="#0" >
                        View<span><svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" className="transform transition-transform duration-500 ease-in-out"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg></span>
                      </a>
                    </div>
                  </div>
            ...
            <ul className="my-1">
              <li className="flex px-4">
                ...
                <div className="flex-grow flex items-center border-gray-100 text-sm text-gray-600 py-2">
                  <div className="flex-grow flex justify-between items-center">
                    <div className="self-center">
                      <a className="font-medium text-gray-800 hover:text-gray-900 outlineStyle" href="#0" >240+</a> users have subscribed to <a className="font-medium text-gray-800 outlineStyle" href="#0">Newsletter #1</a>
                    </div>
                    <div className="flex-shrink-0 ml-2">
                      <a className="flex items-center font-medium text-blue-500 hover:text-blue-600 outlineStyle" href="#0"  >
                        View<span><svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" className="transform transition-transform duration-500 ease-in-out"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg></span>
