...
const ClientTable = () => {
    return (
        <div className="mt-4 mx-4" id="client">
                    ...
                    <table className="w-full">
                        ...
                        <tbody className="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            ...
                            <tr className="bg-gra-50 hover:bg-gray-100 text-gray-700 dark:text-gray-400">
                                ...
                                <td className="px-4 py-3 text-xs">
                                    <span className="px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-100 rounded-full dark:text-white dark:bg-orange-600"> Pending </span>
                                </td>
