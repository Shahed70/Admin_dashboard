...
const Header = () => {
    return (
        <div className="fixed w-full flex items-center justify-between h-14 text-white z-10">
            ...
            <div className="flex justify-between items-center w-full h-14 bg-blue-800 header-right">
                <div className="bg-white rounded flex items-center  ml-auto w-full max-w-xl mr-4 p-2 shadow-sm border border-gray-200">
